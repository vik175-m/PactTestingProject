# -*- encoding: utf-8 -*-
# stub: pact-provider-verifier 1.38.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.add_development_dependency(%q<word_wrap>.freeze, [">= 0"])
end
