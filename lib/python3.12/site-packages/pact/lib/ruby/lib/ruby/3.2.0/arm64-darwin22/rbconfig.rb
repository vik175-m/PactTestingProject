...
module RbConfig
  ...
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/3.2.0/arm64-darwin22")
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/tmp/ruby-3.2.3-arm64/inst")
  ...
  CONFIG["RUBY_EXEC_PREFIX"] = "/tmp/ruby-3.2.3-arm64/inst"
  ...
  CONFIG["build"] = "aarch64-apple-darwin22"
  ...
  CONFIG["build_alias"] = "aarch64-apple-darwin22"
